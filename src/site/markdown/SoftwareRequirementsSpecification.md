...
#### [ΠΧ1 Διαχείριση Προφίλ Επενδυτή](uc1-user-profile.md)

#### [ΠΧ2 Διαχείριση Υπολοίπου Χρήστη](uc2-balance-management.md)

#### [ΠΧ3 Διαχείριση Χαρτοφυλακίου](uc3-portfolio-management.md)

#### [ΠΧ4 Παραγωγή Αναφοράς Κατάστασης Χαρτοφυλακίου](uc4-portfolio-report.md)
...
#### [ΠΧ10 Αυθεντικοποίηση Χρήστη](uc10- user-authentication.md)
...
![Κλάσεις Ανάλυσης](uml/reqs/analysis-classes.png)
...
![Διάγραμμα ακολουθίας - Άνοιγμα Λογαριασμού](uml/reqs/sequence-create-account.png)

#### Ανάληψη μετρητών από ταμείο

![Διάγραμμα ακολουθίας - Ανάληψη μετρητών](diagrams/sequence-make-withdrawal.png)
